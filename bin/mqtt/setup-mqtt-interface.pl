...
# ---------------------------------------------------------------------
# Proven working ACL for multi-client Text2Speech setups.
# Allows T2S Master and all Bridges to communicate freely
# on TTS and handshake topics, but isolates from system topics.
# =====================================================================

# --- Bridge Clients (CN = t2s-bridge*, can be multiple) ---
user $CLIENT_ID
