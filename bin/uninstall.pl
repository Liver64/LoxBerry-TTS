...
system('systemctl','restart','mosquitto');
system('pkill','-f','mqttgateway.pl');
system('start-stop-daemon','--start','--background','--chuid','loxberry',
       '--exec','/usr/bin/perl','--','REPLACELBHOMEDIR/sbin/mqttgateway.pl');
